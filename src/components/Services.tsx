...
export function Services() {
  return (
    <div className="bg-amber-100 p-8 rounded-3xl">
      <div className="flex gap-4 items-center">
        ...
        />
        <h2 className="text-3xl font-bold text-black">PARA SUA <br /><span className="text-blue-700">ESCOLA</span></h2>
      </div>

      <div className="flex flex-wrap md:flex-nowrap gap-8 mt-8">
        <div className="flex flex-wrap rounded-lg p-8 bg-amber-200 gap-4">
          <h3 className="font-bold uppercase text-blue-700">Consultoria pedagógica</h3>
        ...
        <div className="flex flex-wrap rounded-lg p-8 bg-amber-200 gap-4">
          <h3 className="font-bold uppercase text-blue-700">Palestras e treinamento</h3>
          <p className="text-black">
        ...
        <div className="flex flex-wrap rounded-lg p-8 bg-amber-200 gap-4">
          <h3 className="font-bold uppercase text-blue-700">Cartilhas e protocolos antirracistas</h3>
          <p className="text-black">
